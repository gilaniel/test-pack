...
export const Campaigns = ({ color }) => (
  <svg
    ...
    xmlns="http://www.w3.org/2000/svg"
  >
    <path d="M6 5H4V12C4 13.1 4.9 14 6 14H15V12H6V5Z" fill="#4510F6" />
    <path
      d="M18 0H10C8.9 0 8 0.9 8 2V8C8 9.1 8.9 10 10 10H18C19.1 10 20 9.1 20 8V2C20 0.9 19.1 0 18 0ZM18 8H10V4H18V8Z"
      fill="#4510F6"
    />
    <path d="M2 9H0V16C0 17.1 0.9 18 2 18H11V16H2V9Z" fill="#4510F6" />
  </svg>
);
...
export const Download = ({ color }) => (
  <svg
    ...
    xmlns="http://www.w3.org/2000/svg"
  >
    <path d="M14 6H10V0H4V6H0L7 13L14 6ZM0 15V17H14V15H0Z" fill="#4510F6" />
  </svg>
);
